...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 22 oct. 2024 à 21:07
...
CREATE TABLE IF NOT EXISTS `compte` (
  ...
  `identifiant` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vehicule` (
  ...
  `cvfiscaux` int NOT NULL,
  `description_vehic` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
